...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void registerWithNoValidUser() throws Exception {
    ...
    @Test
    void updateNotValidUser() throws Exception {
        ...
        USER_MATCHER.assertMatch(userService.get(USER_ID), UserUtil.updateFromTo(new User(user), UserUtil.asTo(user)));
    }
