...
public class MealTestData {
    ...
    public static final LocalDateTime START_DATE_TIME = of(2020, Month.JANUARY, 30, 10, 0);
    public static final LocalDateTime END_DATE_TIME = of(2020, Month.JANUARY, 30, 14, 0);
    public static final List<Meal> meals_start_end_datetime = Arrays.asList(meal2, meal1);
