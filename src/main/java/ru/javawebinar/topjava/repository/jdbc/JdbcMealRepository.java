...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    protected T getDbDateTime(LocalDateTime dateTime){
        return (T) dateTime;
    }
    ...
    public static class JdbcMealHsqldbRepository extends JdbcMealRepository<Timestamp>{
        ...
        @Override
        protected Timestamp getDbDateTime(LocalDateTime dateTime) {
    ...
    @Repository
    public static class JdbcMealPostgresRepository extends JdbcMealRepository<LocalDateTime>{
